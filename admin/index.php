    ...
    <nav class="navbar navbar-expand-md bg-dark navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav  ml-auto">
                <li class="text-light">Login Sebagai :
        ...
        <div class="row">
            <div class="col-sm-2">
                <div class="list-group">
                    <a href="index.php?halaman=kategori" class="list-group-item list-group-item-action">Wisata</a>
                    <a href="index.php?halaman=review" class="list-group-item list-group-item-action">Review</a>
            ...
            <div class="col-sm-10">
                ...
                if (isset($_GET['halaman'])) {
                    ...
                    switch ($halaman) {
                        case 'kategori':
                            include "wisata/kategori.php";
                            break;
                        case 'wisata':
                            include "wisata/index.php";
                            break;
                        case 'review':
                            include "review/index.php";
                            break;
                        case 'admin':
